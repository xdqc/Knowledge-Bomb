...
(function() {
    ...
    if (langCount < 20 ||
        ...
        const cateStop = ['Disambiguation pages',
                          ...
                          'Characters in Greek mythology', 'Kings in Greek mythology', 'Trojans', 'Lines of succession', 'Grammarians of Latin', 'FIFA World Cup squads', 'Association football rankings',
                          ...
                          'Grammy Awards', 'Disproven exoplanets', 'Gregorian calendar', 'Circles of latitude', 'Television festivals', 'Deserts of China', 'Musical quartets', 'Tennis awards',
                          'Welsh historians', 'Former counties of Denmark (1970–2006)', 'Intel microcontrollers', 'Set indices on populated places in Russia', 'Nokia mobile phones', 'Motorola mobile phones',
                          ...
                          'Halloween television specials', '2010 deaths', '2021 deaths', 'International professional associations', 'Gothic painters', 'Byzantine painters', 'Billboard charts',
                          'People of the Quran', 'Legendary Islamic people', 'Individual chimpanzees', 'Women astronomers', 'High Priests of Israel', 'Roman-era Jews', 'Mythological kings', 'Regicides',
                          'Tibetan Buddhists from Tibet', 'College of Cardinals', 'National Basketball Association All-Star Game', 'National Basketball Association lists', 'Anime with original screenplays',
