...
(function() {
    ...
    if (langCount < 20 ||
        ...
        const cateStop = ['Disambiguation pages',
                          ...
                          'Set indices', 'Set indices on populated places in Russia', 'Set indices on ships', 'Set indices on cars', 'Top lists',
                          ...
                          'Fabulists', 'Praetorian prefects', 'Veterinarians', 'People in the Pauline epistles',
                          ...
                          'Characters in Greek mythology', 'Kings in Greek mythology', 'Legendary Islamic people', 'Medieval legends',
                          ...
                          'Women satirists', 'Women astronomers', 'Queens consort of the Fourth Dynasty of Egypt', 'Queens consort of the Nineteenth Dynasty of Egypt',
                          'Male characters in literature', 'Greek New Testament uncials', 'Vetus Latina New Testament manuscripts',
                          ...
                          'Forbes lists', 'International rankings', 'Sports world rankings', 'Billboard charts',
                          'Grammy Awards', 'Television festivals', 'Musical quartets', 'Tennis awards', 'Golden Globe Awards', 'French awards', 'British awards',
                          ...
                          'Actress filmographies', 'Male actor filmographies', 'American films', 'American film awards', 'French film awards', 'Anime with original screenplays',
