...
SELECT ?desc WHERE {
  ...
  FILTER ( lang(?desc) = "${i}" )
}`;try{const a=await this.fulfillWithTimeLimit(fetch("https://query.wikidata.org/sparql?query="+t,{headers:{Accept:"application/json"}}),2e3,null);if(!a)throw isFuzzy=!0,"wikidata query timeout 2000";var s=(await a.json()).results.bindings;return s[0]?s[0].desc.value:null}catch(t){console.error("sparqlGetDescription",e,i,err)}},fetchFuzzyAnswer:async function(t){var e=await this.queryFuzzyAnswer(t.q_id,this.transLangCode(this.alang));if(!e.aid||!e.atitle)return!1;0<=t.answer&&t.choices.splice(t.answer,1),this.unpackRespData(t);const i=t=>t.charAt(0).toUpperCase()+t.substring(1);e=i(e.atitle),t=t.choices.map(t=>i(t));return this.choices=[e,...t],this.shuffleArray(this.choices),this.answer=this.choices.indexOf(e),!0},queryFuzzyAnswer:async function(t,e){let i=await this.sparqlGetSiblings(t,e,"","",!0);return i.isFuzzy?i:(i=await this.sparqlGetSiblings(t,e,"wdt:P31?","wdt:P31?"),i.isFuzzy?i:(i=await this.sparqlGetSiblings(t,e,"wdt:P31?","wdt:P31?/wdt:P279"),i.isFuzzy?i:(i=await this.sparqlGetSiblings(t,e,"wdt:P31?/wdt:P279","wdt:P31?/wdt:P279?"),i.isFuzzy?i:(i=await this.sparqlGetSiblings(t,e,"wdt:P31?/wdt:P279/wdt:P279","wdt:P31?/wdt:P279/wdt:P279"),i.isFuzzy?i:(i=await this.sparqlGetSiblings(t,e,"wdt:P31?/wdt:P279/wdt:P279/wdt:P279","wdt:P31?/wdt:P279+"),i.isFuzzy,i)))))},sparqlGetSiblings:async function(e,i,t="wdt:P31?",s="wdt:P31?",a=!1){let n=0,l="",o=!1;s=a?`SELECT DISTINCT * WHERE {
{
  SELECT DISTINCT
  ?sim ?simLabelA  
    WHERE {
