...
(function() {
    ...
    if (langCount < 20 ||
        ...
        const infoStop = new Set(['Abode', 'Abolished', 'Active', 'Active regions', 'Address', 'Administration', 'Adopted', 'Adoption', 'Affiliation', 'Affiliations', 'Allegiance', 'Ancestor', 'Apastron', 'Appearances', 'Appointer', 'Architect',
                                  ...
                                  'Champions', 'Chancellor', 'Circuit length', 'Cleavage', 'Closed', 'Coalescence age', 'Commander', 'Commanders', 'Commissioned by', 'Competition', 'Completed', 'Composed', 'Composer(s)', 'Composers', 'Conductor',
                                  ...
                                  'Episodes', 'Established', 'Expenses', 'Expiration', 'Father', 'FIFA affiliation', 'Feast', 'Filename extension', 'Filling', 'Final ruler', 'First appearance', 'First flight', 'First induction',
                                  'First issued', 'First published', 'First race', 'Folded', 'Followed by', 'Formed', 'Founded by', 'Founder(s)', 'Fracture', 'Full name', 'Gauge', 'Gender', 'General manager', 'Government', 'Government website', 'Half-life',
                                  ...
                                  'Medal record', 'Media type', 'Medium', 'Members', 'Membership', 'Merger of', 'Monarch(s)', 'Most titles', 'Most wins', 'Most wins (team)', 'Motives', 'Motto', 'NCBI', 'National origin', 'Nationality',
                                  ...
                                  'Parent company', 'Parents', 'Past members', 'Peerage', 'Penumbral', 'Performance', 'Periastron', 'Perpetrator', 'Perpetrators', 'Pfam', 'Pharmacology', 'Phonetic usage', 'Platform', 'Political groups',
                                  ...
                                  'Source', 'Sovereign', 'Speed', 'Spouse', 'Stations', 'Studio', 'Studio albums', 'Successor', 'TLD type', 'Team colors', 'Teams', 'Temperature', 'The Cyrillic script', 'Thickness', 'Total produced', 'Tournament', 'Track gauge',
                                  'Trade names', 'Transliterations', 'Transmission', 'Tributaries', 'UniProt', 'Unicode codepoint', 'Units', 'User(s)', 'UTC offset', 'Variant form(s)', 'Variants', 'Venerated in', 'Verdict', 'Volumes', 'Web site', 'Website', 'Wingspan',
        ...
        const cateStop = new Set(["1st-century Romans", "16th-century Christian texts",
                                  "2010 censuses", "2020 censuses", "2021 deaths", "2022 deaths", "2023 deaths", "2024 deaths", "2025 deaths", "20th-century American astronomers",
                                  "3rd-century BC Greek philosophers", "6th-century Arab people", "9th-century births",
                                  ...
                                  "Ancient Arcadian poets", "Ancient Argives", "Ancient Athenian sculptors", "Ancient Athenian women", "Ancient Egyptian scribes", "Ancient Ephesians", "Ancient Eretrians", "Ancient Greek astronomers", "Ancient Greek biographers",
                                  "Ancient Greek elegiac poets", "Ancient Greek ethicists", "Ancient Greek grammarians", "Ancient Greek mathematicians", "Ancient Greek philosophers", "Ancient Greek poets", "Ancient Greek rhetoricians", "Ancient Greek sculptors", "Ancient Greek statesmen",
                                  ...
                                  "Antipopes", "Aphorists", "Apocryphal epistles", "Arabic alphabets", "Arabic letters", "Arctic expeditions", "Armenian historians", "Arts gods", "Association football governing bodies",
                                  "Association football museums and halls of fame", "Association football rankings", "Astronomers of medieval Islam", "ATP Tour", "Attic orators",
                                  "Barcids", "Berber writers", "Biblical phrases", "Billboard charts", "Bisexual poets", "Book of Genesis people", "Books in art", "British Academy Film Awards", "British awards", "Buddhist artists", "Buddhist crisis", "Byzantine historians",
                                  "Byzantine painters", "Byzantine people of Armenian descent", "Byzantine poets",
                                  "COVID-19 pandemic by country", "Canon EOS cameras", "Carbines", "Carthaginians", "Catholic painters", "Chapters in the Quran", "Characters in Greek mythology", "Characters in the Odyssey", "Chemistry set index articles",
                                  "Christian poets", "Christian writers", "Church Fathers", "Circles of latitude", "Climate by country", "College of Cardinals", "Comarques of Catalonia", "Comics awards", "Commentators on Aristotle", "Comedy sketches",
                                  "Configuration files", "Constitutions by country", "Constructed language creators", "Cyrillic letters", "Cubist artists",
                                  "Dakar Rally", "Daughters of kings",
                                  "Days of the year","Days of January", "Days of February", "Days of March", "Days of April", "Days of May", "Days of June", "Days of July", "Days of August", "Days of September", "Days of October", "Days of November", "Days of December",
                                  "Defunct UEFA club competitions", "Defunct computer companies of the United States", "Defunct national association football supercups",
                                  "Deserts of China", "Development regions of Romania", "Diesel hybrid vehicles", "Disambiguation pages", "Disproven exoplanets", "Dutch Golden Age painters", "Dutch male painters",
                                  "Early Greek epic poets", "Early Greek historians", "Elegiac poets", "Emirs of Mosul", "English feminine given names", "English masculine given names", "Ethnic Armenian historians", "Euro coins by issuing country",
                                  ...
                                  "FIA Formula 2 Championship seasons", "FIFA World Cup squads", "FIFA World Cup-related lists", "Fabulists", "Fictional characters who use magic", "Fictional magic schools", "Fifth-level administrative divisions by country",
                                  "Film by year",
                                  "First-level administrative divisions by country", "Followers of Jesus", "Forbes lists", "Former counties of Denmark (1970–2006)", "Former populated places in Russia", "Former populated places in West Asia", "Formula E seasons", "Formula One seasons",
                                  "Fourth-level administrative divisions by country", "Frankish historians", "Frankish warriors", "French male poets", "French Roman Catholics", "French awards", "French film awards", "French poets",
                                  "General elections in the United States", "Generals of Alexander the Great", "Geographical regions of Serbia", "Georgian letters", "German alchemists", "German male writers", "German opera companies", "German poets", "German Romantic composers",
                                  ...
                                  "Historical regions", "Historical regions in Romania", "Historical regions in Russia", "Historical regions in Ukraine", "Historical regions of Transylvania", "Historically recognized angiosperm families",
                                  ...
                                  "Illuminated biblical manuscripts", "Indian Buddhist monks", "Individual angels", "Individual chimpanzees", "Individual dogs", "Intel microcontrollers",
                                  "International borders", "International professional associations", "International rankings", "Iranian historians",
                                  "Iranian rulers", "Irish explorers", "Islam by country", "Islamic terminology", "Italian male sculptors", "Italian operatic basses", "Italian poets",
                                  "Japanese eras", "Jesuit scientists", "Jewish apocrypha", "Jewish composers", "Jewish historians", "Jewish philosophers",
                                  ...
                                  "Members of the Unrepresented Nations and Peoples Organization", "Meridians (geography)", "Military trucks", "Motorola mobile phones", "Music industry associations", "Music by year", "Musical quartets",
                                  "Mythological kings", "Mythological rape victims",
                                  ...
                                  "National association football supercups", "National coats of arms", "National emblems", "National squares", "Nazi newspapers", "Neoplatonists", "Nokia mobile phones", "Nonexistent people", "Novels adapted into operas",
                                  "Observances in Russia", "Obsolete animal taxa", "Obsolete gastropod taxa", "Operas", "Opera excerpts",
                                  ...
                                  "People whose existence is disputed", "Persian letters", "Pharaohs of the Second Dynasty of Egypt", "Plains of Iran", "Plays set in England", "Politics by country", "Pop-folk music groups", "Praetorian prefects",
                                  "Presidents by country", "Princesses in Greek mythology", "Protestant Reformers", "Psalms", "Psalms people", "Pulp magazines",
                                  "Queens consort of the Eighteenth Dynasty of Egypt", "Queens consort of the Fourth Dynasty of Egypt", "Queens consort of the Nineteenth Dynasty of Egypt", "Queens of Egypt", "Queens of Rome",
                                  "Queens of the Achaemenid Empire",
                                  "Railway loop lines", "Regicides", "Regions of Rajasthan", "Regnal titles", "Renaissance architecture in Germany", "Renaissance artists", "Retired Academy Awards",
                                  "Roman gentes", "Roman legions", "Roman roads in Spain","Roman-era Jews", "Roman-era poets", "Russian male poets", "Russian nobility",
                                  "Sanskrit poets", "Satraps of the Alexandrian Empire", "Scheduled association football competitions", "Second-level administrative divisions by country", "Secret police",
                                  "Set index articles",
                                  ...
                                  "Set indices on comics", "Set indices on populated places in Russia", "Set indices on ships",
                                  "Shaiva texts", "Sicilian tyrants", "Singers awarded knighthoods", "Sky and weather gods", "Society of Authors awards", "Song contests", "Songs with unknown songwriters",
                                  "Soviet novels", "Sports by year", "Spanish football trophies and awards", "Sports event promotion companies", "Sports world rankings", "Subdivisions of Israel", "Subdivisions of Japan", "Sufi orders", "Sumerian cities",
                                  ...
                                  "Tourism in Europe by country", "Tourism-related lists", "Treatises", "Trojan Leaders", "Trojans",
                                  ...
                                  "Vehicle registration plates by country", "Veterinarians", "Vetus Latina New Testament manuscripts", "Vice presidents", "Viking explorers", "Viking warriors", "Volcanic plugs of Asia", "Vowel letters",
                                  "Welsh historians", "Winter Paralympic Games",
                                  "Women astronomers", "Women by country", "Women companions of the Prophet", "Women of Poseidon", "Women of the Trojan war", "Women rulers of Egypt", "Women satirists",
                                  "World championships in chess", "Writers from the Russian Empire",
                                  "Years of the 20th century in literature", "Year of birth unknown", "Year of death unknown", "Yugoslav communists"
                                 ]);
