...
(function() {
    ...
    if (langCount < 20 ||
        ...
        const infoStop = new Set(['CAS Number', 'CAS no.', 'PubMed search', 'SIMBAD', 'X-SAMPA', 'Pfam', 'RefSeq', 'Locus', 'ISSN', 'ISBN', 'TLD type', 'COSPAR ID', 'NCBI', 'UniProt', 'DIN standards',
                                  ...
                                  'Teams', 'Members', 'Champion', 'Champions', 'Competition', 'Association', 'Production', 'Release', 'Repealed', 'Response', 'Membership', 'Ceased', 'Hosts',
        ...
        const cateStop = ['Disambiguation pages',
                          ...
                          'Days of the year',
                          'Set indices', 'Set indices on populated places in Russia', 'Set indices on ships', 'Set indices on cars', 'Set indices on comics',
